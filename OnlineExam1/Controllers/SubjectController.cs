...
namespace OnlineExam1.Controllers
{
    ...
    public class SubjectController : ControllerBase
    {
        ...
        [HttpGet, Route("GetBySiteId/{siteId}")]
        [AllowAnonymous]
        public ActionResult<IEnumerable<SubjectDTO>> GetSubjectsBySiteId(int siteId)
        {
            try
            {
                var subjects = unitOfWork.SubjectRepoImplObject.GetBySiteId(siteId);
